...
class Home():
    ...
    def welcome(self):
        if settings.CURRENT_USER_ROLE == 'ADMIN':
            ...
            print(f"Welcome {settings.CURRENT_USER_ROLE} {settings.CURRENT_USER}".rjust(100, " "))
            print("".center(100,'*'))
        ...
        elif settings.CURRENT_USER_ROLE == 'GUEST':
            print(f"Welcome {settings.CURRENT_USER_ROLE} ".rjust(100, " "))
            print("".center(100,'*'))